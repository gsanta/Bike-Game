...
public class CustomTagEditor : Editor
{
    ...
    {
        unityTags = CustomTag.placementTypes;
        tagsProp = serializedObject.FindProperty("placements");
    ...
    {
        EditorGUI.LabelField(rect, new GUIContent("Placements"), EditorStyles.boldLabel);
    }
